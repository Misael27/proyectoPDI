...
/**
 * Created by MISAEL on 05/11/2016.
 * TODO: Implementar esta clase como un singleton para que sea accesible desde todas las clases y se mantenga una unica instancia
 */
...
public class MyTessOCR {
    ...
    public MyTessOCR(Context context) {
        ...
        File file = new File(datapath + "/tessdata/" + "spa.traineddata"); //eng
        if (!file.exists()) {
            Log.d("mylog", "in file doesn't exist");
            dir.mkdirs();
            file = new File(datapath + "/tessdata/" + "spa.traineddata"); //eng
            copyFile(context);
        }
